...
OUTPUT = Path("scratch_root_e72_source150_small5_joint_primary_partial_audit.json")
...
def freeze_closed_macro(row, records, audited_shards, base_hashes):
    ...
    path = Path(f"scratch_root_e72_source150_small5_joint_primary_m{macro[0]}{macro[1]}_complete_audit.json")
    if path.exists():
