...
明示的な再開指示までは新たな探索を起動しません。

2026-09-17 に研究を再開した際の現在の主張台帳は
[CLAIMS.yaml](CLAIMS.yaml)、最新の完了済み検証は
[第8波の独立監査](docs/RESEARCH_20260917_EIGHTH_WAVE.md) です。
第8波では、144本の外側辺と所定の非辺を固定した配置族を厳密に排除し、さらに広い配置族の局所候補と必要条件モデルを独立検証しました。一般の非存在証明ではなく、
