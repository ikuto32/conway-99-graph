...
def main():
    ...
    require(phase["status"] == "INDEPENDENT_COUPLED_ACCEPTED_PHASE1_INTERVAL_AUDIT_PASS", "Phase audit incomplete")
    ...
    report = dict(status="INDEPENDENT_COUPLED_BEST_LOCAL_PASS_GLOBAL_OBSTRUCTION_BOUND",
