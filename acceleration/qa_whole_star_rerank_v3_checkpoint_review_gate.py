...
def fixtures():
    ...
    scope=dict(status='INDEPENDENT_WHOLE_STAR_RERANK_V3_SHORTLIST_AUDIT_PASS',evaluation_path=a.evaluation,
...
def main():
    ...
    out=dict(status='WHOLE_STAR_RERANK_V3_CHECKPOINT_REVIEW_GATE_CONTROLS_PASS',timestamp=datetime.now(timezone.utc).isoformat(),
