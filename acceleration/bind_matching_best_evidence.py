...
def main():
    ...
    require(phase["status"] == "INDEPENDENT_WHOLE_MATCHING_ACCEPTED_PHASE1_INTERVAL_AUDIT_PASS", "Phase audit incomplete")
    ...
    report = dict(status="INDEPENDENT_WHOLE_MATCHING_BEST_LOCAL_PASS_GLOBAL_OBSTRUCTION_BOUND",
