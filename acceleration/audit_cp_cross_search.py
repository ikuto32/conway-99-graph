"""Independent cross3/4 CUDA-CP ranking and fixed-K LP audit.
...
def main():
    ...
    for path in (Path(__file__), ROOT / "acceleration/audit_certificate.py", ROOT / "acceleration/audit_phase1.py", ROOT / "acceleration/audit_phase1_kkt.py"):
        bind(path)
    report = dict(status="INDEPENDENT_CP_CROSS_SEARCH_AUDIT_PASS", audited_producer_version="cross1", inputs_sha256=hashes,
