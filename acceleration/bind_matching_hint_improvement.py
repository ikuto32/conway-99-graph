...
def main():
    ...
    require(summary['status'] == 'BOUNDED_MATCHING_HINT_SHORTLIST_FINISHED', 'Incomplete shortlist')
    ...
    sources = [args.summary, args.previous_candidate, args.previous_phase1, candidate_path, phase_path,
