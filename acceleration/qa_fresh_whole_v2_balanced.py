...
from rank_fresh_whole_v2_balanced import (argument_parser,digest,execution_gate,geometry,key,load_sources,
...
def main():
    ...
    reject('CHANGED_SOURCE_BINDING',lambda r:r['inputs_sha256'].__setitem__('acceleration/rank_fresh_whole_v2_balanced.py','0'*64))
