"""Independently recover a CP audit using explicit higher-accuracy LP replacements.
...
def main():
    ...
    bind(args.view_out)
    report = dict(status="INDEPENDENT_CP_MATCHING_REPAIRED_LP_AUDIT_PASS", audited_producer_version=2, inputs_sha256=hashes,
