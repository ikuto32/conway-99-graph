"""Checkpointed direct exact runner for five remaining source150 macros."""
...
MANIFEST = Path("scratch_root_e72_source150_small5_shard_run_manifest.json")
EXPECTED = {
    (1, 0): 96,
    (3, 3): 116,
    (9, 0): 52,
...
def validate(
    path: Path, macro: tuple[int, int], start: int, stop: int
) -> dict[str, object]:
